from enumDefinitions import GcodeCommands, GcodeCheckActions


class GcodeCheckItem:
    def __init__(self, command: GcodeCommands, checkAction: GcodeCheckActions, actionValue: str):
        """
        Check to perform on the gcode file.
        param commandType: Type of command to perform. See GcodeCommands Enum.
